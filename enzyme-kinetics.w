...
\section{Fit data to approximate set, Edited}
The python function to fit the approximate set of 
differential equations is called fitdiffeqset
...
<<fitdiffeqset>>=
def fitdiffeqset(Td, Zd, parameters):
...
(Tfit,Pfit,Tmfit,Zmfit,nk1,nkm1,nk2) = fitdiffeqset(Td,Zd,parameters1)
